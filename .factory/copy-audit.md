...
Every visitor-visible sentence, heading, action, caption, fact, and disclosure in `site/index.html` is listed below. Labels made only of the product name, file paths, dates, or code commands are included where they convey product information.
...
| --- | --- |
| User-chosen folder or file | source |
| Indexed unit | record |
| Matching text around a query | result |
| Bundled isolated data | sample project |
| Evidence linking a result to its file | source trail |
