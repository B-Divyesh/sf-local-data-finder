...
Open `/?demo=1` from the site, or choose **Load sample project** on the first desktop-app screen. The browser redirects to `/demo/?demo=1` and shows a persistent **Demo — sample data, nothing is saved with your archive** banner with **Reset demo** and **Start for real**.
